...
givem_name varchar(50) not null,
...
cantact_name varchar(255),
cantact_email varchar(255),
title varchar(255),
...
INSERT INTO users(phone_email, password, login_flg, user_flg, family_name, givem_name, family_name_kana, given_name_kana,
...
-- category(1:)
INSERT INTO item(item_name, category, item_price, item_stock, img_path, comment, item_flg, release_flg) VALUE
('Pair mug cup'),
(),
(),
(),

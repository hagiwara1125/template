...
<link rel="stylesheet" type="text/css" href="./css/user_itemlist.css">
<link rel="stylesheet" type="text/css"
	href="./css/user_Product_Details.css">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="gnavi">
						<ul class="navbar-right nav navbar-nav">
							<li><a href="GoTopAction"><span
									class="glyphicon glyphicon-home"></span>Top</a></li>
							<li><a href="GoRecipeListAction"><span
									class="glyphicon glyphicon-cutlery"></span>Recipes</a></li>
							<li class="active"><a href="UserItemListAction"><span
									class="glyphicon glyphicon-briefcase"></span>Products</a></li>
							<li><a href="GoMypageAction"><span
									class="glyphicon glyphicon-th-list"></span>Mypage</a></li>
							<li><a href="GoCartAction"><span
									class="glyphicon glyphicon-shopping-cart"></span>Cart</a></li>
							<li><a href="GoContactAction"><span
									class="glyphicon glyphicon-earphone"></span>Contact</a></li>
							<li><a href="LogoutAction"><span
									class="glyphicon glyphicon-leaf"></span>Logout</a></li>
						</ul>
					</div>
				</nav>
			</s:if>
					...
					<div class="collapse navbar-collapse" id="gnavi">
						<ul class="navbar-right nav navbar-nav">
							...
							<li><a href="about.jsp"><span
									class="glyphicon glyphicon-th-list"></span>About</a></li>
							<li><a href="contact.jsp"><span
									class="glyphicon glyphicon-earphone"></span>Contact</a></li>
							<li><a href="login.jsp"><span
									class="glyphicon glyphicon-leaf"></span>Login</a></li>
						</ul>
					</div>
				</nav>
			</s:else>
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<nav>
								<ul class="pagination">
									...
									<s:else>
										<li><a
											href="<s:url action="ItemListAction"><s:param name="page_num" value="1"/><s:param name="item_category" value="%{item_category}"/></s:url>"
											aria-label="1ページへ"> <span aria-hidden="true">&laquo;</span>
										</a></li>
									</s:else>

									<s:iterator value="list" status="st">
										<s:if test="list.get(#st.index) == page_num">
											<li class="active"><a><s:property
														value="list.get(#st.index)" /></a></li>
										</s:if>
										<s:else>
											<li><a
												href="<s:url action="ItemListAction"><s:param name="page_num" value="%{list.get(#st.index)}"/><s:param name="item_category" value="%{item_category}"/></s:url>"><s:property
														value="list.get(#st.index)" /></a></li>
										</s:else>
									</s:iterator>

									<s:if test="page_num==max_page">
										<li class="disabled"><span aria-hidden="true">&raquo;</span>
										</li>
									</s:if>
									<s:else>
										<li><a
											href="<s:url action="ItemListAction"><s:param name="page_num" value="%{max_page}"/><s:param name="item_category" value="%{item_category}"/></s:url>"
